...
class PadFull4RowsKeyboardViewLayout : KeyboardViewLayout {
    ...
    static let letters: [[[KeyCap]]] = [
        ...
        [[.toggleInputMode(.english)], ["a", "s", "d", "f", "g", "h", "j", "k", "l"], [.returnKey(.default)]],
    ...
    static let numbersHalf: [[[KeyCap]]] = [
        ...
        [[.placeholder(.toggleInputMode(.english))], ["@", "#", .currency, "/", "(", ")", "「", "」", .singleQuote], [.returnKey(.default)]],
    ...
    static let symbolsHalf: [[[KeyCap]]] = [
        [["\t"], ["1", "2", "3", "4", "5", "6", "7", "8", "9", "0"], [.backspace]],
        [[.placeholder(.toggleInputMode(.english))], ["^", "_", "|", "\\", "[", "]", "{", "}", .doubleQuote], [.returnKey(.default)]],
