...
class PadFull5RowsKeyboardViewLayout : KeyboardViewLayout {
    ...
    static let letters: [[[KeyCap]]] = [
        ...
        [[.toggleInputMode(.english)], ["a", "s", "d", "f", "g", "h", "j", "k", "l", .contextual(";"), .singleQuote], [.returnKey(.default)]],
    ...
    static let numbersHalf: [[[KeyCap]]] = [
        ...
        [["\t"], ["[", "]", "{", "}", "#", "%", "^", "*", "+", "=", "\\", "|", "_"], []],
        [[.placeholder(.toggleInputMode(.english))], ["-", "/", ":", ";", "(", ")", .currency, "&", "@", .singleQuote, .doubleQuote], [.returnKey(.default)]],
