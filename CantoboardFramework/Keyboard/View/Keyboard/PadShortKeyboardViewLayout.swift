...
class PadShortKeyboardViewLayout : KeyboardViewLayout {
    ...
    static let letters: [[[KeyCap]]] = [
        ...
        [[.nextKeyboard, .keyboardType(.numeric), .toggleInputMode(.english)], [.space(.space)], [.keyboardType(.numeric), .dismissKeyboard]]
    ]
    ...
    static let numbersHalf: [[[KeyCap]]] = [
        ...
        [[.nextKeyboard, .keyboardType(.alphabetic(.lowercased)), .toggleInputMode(.english)], [.space(.space)], [.keyboardType(.alphabetic(.lowercased)), .dismissKeyboard]]
    ]
