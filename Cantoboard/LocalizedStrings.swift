...
class LocalizedStrings {
    ...
    static let candidateSelectMode = localizedString("inputMethodSettings.candidateSelectMode")
    static let candidateSelectMode_expandDownward = localizedString("inputMethodSettings.candidateSelectMode.expandDownward")
    static let candidateSelectMode_scrollRight = localizedString("inputMethodSettings.candidateSelectMode.scrollRight")
